...
payloads=(
	...
	"rootfs/system/icons/start_icon.bmp::system/icons/start_icon.bmp"
...
# System Apps
	...
	"userspace/bin/wipe/wipe.elf::system/bin/wipe.elf"
	"userspace/bin/mkfs/mkfs.elf::system/bin/mkfs.elf"
