/* userspace/lib/ttf.h - minimal TrueType renderer over lib/gfx.
 *
 * Implementation: userspace/lib/ttf.c.
 */
#ifndef TTF_H
#define TTF_H
...
/* Returns 0 on success. Negative returns identify the failed stage:
 * -2 open, -3 seek-end, -4 size/rewind, -5 alloc, -6 read, -7 parse. */
