/* src/intf/arch/percpu.h — per-CPU data area.
 *
 ...
 *
 * Layout is shared with asm: SYSCALL entry (src/impl/x86_64/cpu/syscall.asm)
 ...
 *
 * Implementation: src/impl/kernel/arch/percpu.c.
 */
#ifndef PERCPU_H
#define PERCPU_H
